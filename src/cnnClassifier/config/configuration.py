...
class ConfigurationManager:
    ...
    def get_prepare_base_model_config(self) -> PrepareBaseModelConfig: #specifying the return type
    ...
    def get_evaluation_config(self) -> EvaluationConfig:
        eval_config = EvaluationConfig(
            ...
            mlflow_uri="https://dagshub.com/imkishor16/Cancer-Classification-.mlflow",
